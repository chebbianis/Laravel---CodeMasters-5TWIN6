...
<section class="catalog" id="catalog" style="padding: 4rem 0; background: rgba(255,255,255,0.1); backdrop-filter: blur(10px);">
    <div class="container">
        <h2 style="text-align:center; color:white; margin-bottom:2rem;">Catalogue des Objets</h2>
        <div id="items-grid" class="features-grid">
...
<a href="{{ route('catalogue') }}" class="btn">Voir le catalogue</a>
</div>
